  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'mahamudulhasanjony26@gmail.com',
      link: 'mahamudulhasanjony26@gmail.com',
    },
    {
      icon: (
      ...
      label: 'GitHub',
      value: 'https://github.com/Jony9t69',
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <a
                    ...
                    className="flex items-start p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group"
                  >
